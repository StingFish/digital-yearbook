  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $_SESSION['User2']; ?></a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      $year = date("Y");
        ...
        $sql = "SELECT * from confirmed WHERE usertype='Student' ORDER BY Sid";
        $searchKey="";
        $name="";
      }
        $result = mysqli_query($db,$sql);
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          echo "<td align='center'>
                ...
                <a class='delbtn' style='text-decoration:none;' href ='af.php?edit=".$row['id']."'><i class='fa fa-edit'></i></a>
                  </button>
                  <button class='.btn bg-danger' style='border:1px solid;width:30px;'>
                <a class='delbtn' style='text-decoration:none; color:white;' href='af.php?email=".$row['email']."'><i class='fa fa-trash'></i></a>
                  </button>
                </td>";
          echo "</tr>";
        }
