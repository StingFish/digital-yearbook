        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Request Accounts</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-gradient-primary">
                <h3 class="card-title">Request Accounts</h3>
              </div>
          ...
          echo "<td align='center'>
                ...
                <a class='delbtn' style='text-decoration:none; color:white;' href ='af.php?editan=".$row['id']."'><i class='fa fa-check'></i></a>
                  </button>
                  <button class='.btn-sm bg-danger' style='border:1px solid;width:30px;'>
                <a class='delbtn' style='text-decoration:none; color:white;' href='af.php?emailan=".$row['email']."'><i class='fa fa-times'></i></a>
                  </button>
                </td>";
          echo "</tr>";
          echo "</tr>";
