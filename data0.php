...
<head>
  ...
  <title>Milestones & Activities</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="data0.php" class="nav-link active">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Milestones & Activities</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <?php
      ...
      $year = date("Y");
        ...
        $sql = "SELECT * from tab11 where year LIKE '%$searchKey%' ORDER BY year";
        $result = mysqli_query($db,$sql);
        $rows = mysqli_num_rows($result);
      }else{
        $sql = "SELECT * from tab11 ORDER BY year";
        $searchKey="";
        $name="";
      }
        $result = mysqli_query($db,$sql);
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-gradient-primary">
                <h3 class="card-title">Milestones & Activities</h3>
              </div>
          ...
          echo "<td align='center'>
                  <button class='.btn bg-success' style='border:1px solid;width:30px;'>
                <a class='delbtn' style='text-decoration:none;' href ='af2.php?edit11=".$row['id']."'><i class='fa fa-edit'></i></a>
                  </button>
                  <button class='.btn bg-danger' style='border:1px solid;width:30px;'>
                <a class='delbtn' style='text-decoration:none; color:white;' href='af2.php?email11=".$row['id']."'><i class='fa fa-trash'></i></a>
                  </button>
                </td>";
          echo "</tr>";
        }
